...
const cardInfo = [
    ...
    },
    {
        img: card02,
        title:"반응형 사이트 만들기",
        desc: "웹표준 사이트를 완성하고, 반응형을 익히는 사이트입니다. 기본 코딩을 익히고, 반응형 감각을 키우면 모바일 및 반응형 사이트도 만들 수 있습니다. 웹표준 사이트",
    },
    {
        img: card03,
        title:"패랠렉스 사이트 만들기",
        desc: "기업 사이트 중 50% 이상이 패랙렉스 스크로링 효과로 만들어져 있습니다. 웹 표준, 반응형 사이트를 완성하였다면, 이제는 인터랙티브한 패랠렉스 스크롤링 사이",
    }
]
...
const Card = ( props ) => {
  return (
    <section id="cardType" className= {`card__wrap ${props.element}`}>  
        <h2>웹스토리보이 강의</h2>
        <p>웹디자이너, 웹 퍼블리셔, 프론트엔드 개발자를 위한 강의 사이트입니다<br />
